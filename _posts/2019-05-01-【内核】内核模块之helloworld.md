...
所以我们要先安装依赖的函数库（内核代码）。 以我的Fedora 29（kenel version 4.18.16-300.fc29.x86_64）为例，自然要安装对应版本的代码库。 sudo dnf install kernel-devel-4.18.16-300.fc29.x86_64 然后在/usr/src/kernel就可以看到对应代码库了。
开发流程
