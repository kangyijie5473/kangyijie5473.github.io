...
date: 2018-01-31
tags: [Algorithm]
description: "本文解析了LintCode 785题“最大权值和路径”。这是一道经典的动态规划题目，要求寻找从矩阵右上角到左下角的最大权值路径。文章提供了详细的C++代码实现，利用记忆化搜索（递归+备忘录）的方式解决了状态转移问题。"
---
本文解析了LintCode 785题“最大权值和路径”。这是一道经典的动态规划题目，要求寻找从矩阵右上角到左下角的最大权值路径。文章提供了详细的C++代码实现，利用记忆化搜索（递归+备忘录）的方式解决了状态转移问题。
