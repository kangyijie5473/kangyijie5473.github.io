...
description: 介绍如何在Linux终端制作一个圣诞惊喜。利用 `figlet` 生成ASCII艺术字，配合Shell脚本和 `.bashrc` 配置，实现特定日期登录时显示祝福语的效果。
---
介绍如何在Linux终端制作一个圣诞惊喜。利用 `figlet` 生成ASCII艺术字，配合Shell脚本和 `.bashrc` 配置，实现特定日期登录时显示祝福语的效果。
