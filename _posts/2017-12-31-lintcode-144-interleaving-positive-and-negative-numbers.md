...
date: 2017-12-31
tags: [Algorithm]
description: LintCode 144 “交错正负数”题解。分析了正负数交错排列的逻辑，指出了仅仅根据位置奇偶性判断符号的常见错误，并给出了基于正负数计数和交换的正确解法。
---
LintCode 144 “交错正负数”题解。分析了正负数交错排列的逻辑，指出了仅仅根据位置奇偶性判断符号的常见错误，并给出了基于正负数计数和交换的正确解法。
