...
date: 2018-06-30
tags: [Life, C/C++, Linux]
description: "本文介绍了分布式协调服务Apache ZooKeeper的基本概念。作者以“动物园管理员”作比，解释了ZK在分布式系统（如Hadoop）中的作用，包括分布式锁、崩溃检测、服务发现等。重点通过“菜谱”（Recipes）的概念，详解了利用临时有序节点（SEQUENCE|EPHEMERAL）实现Leader选举的原理。"
---
本文介绍了分布式协调服务Apache ZooKeeper的基本概念。作者以“动物园管理员”作比，解释了ZK在分布式系统（如Hadoop）中的作用，包括分布式锁、崩溃检测、服务发现等。重点通过“菜谱”（Recipes）的概念，详解了利用临时有序节点（SEQUENCE|EPHEMERAL）实现Leader选举的原理。
