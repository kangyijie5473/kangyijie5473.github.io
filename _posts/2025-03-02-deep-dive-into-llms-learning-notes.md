...
date: 2025-03-02
tags: [AI]
description: "本文是基于《Deep Dive into LLMs like ChatGPT》的大模型学习笔记。文章深入浅出地解释了模型的定义（类似函数）、数据集的构建与清洗（去重、去敏）、Token化处理（分词与Embedding）、预训练（Pre-training）获取基座模型的过程，以及后训练（SFT）在赋予模型对话能力与减少幻觉方面的作用。"
---
本文是基于《Deep Dive into LLMs like ChatGPT》的大模型学习笔记。文章深入浅出地解释了模型的定义（类似函数）、数据集的构建与清洗（去重、去敏）、Token化处理（分词与Embedding）、预训练（Pre-training）获取基座模型的过程，以及后训练（SFT）在赋予模型对话能力与减少幻觉方面的作用。
...
- ![在这里插入图片描述](/images/b852bc8f-c7aa-473c-aeda-6fbdffe9d9ff.png)

- qwen

![在这里插入图片描述](/images/ebb800da-be2c-4cc5-9a73-97225f066be3.png)
...
示例数据集如下所示：
![在这里插入图片描述](/images/fd625da9-ed4c-44a9-b61d-e332bfa21f18.png)
