...
date: 2017-10-29
tags: [Algorithm]
description: CCF CSP认证试题“炉石传说”的题解。一道复杂的模拟题，要求模拟简化的炉石传说游戏规则，使用C++面向对象思想和STL容器（vector）进行实现。
---
CCF CSP认证试题“炉石传说”的题解。一道复杂的模拟题，要求模拟简化的炉石传说游戏规则，使用C++面向对象思想和STL容器（vector）进行实现。
...
8summon 1 3 6summon 2 4 2endsummon 1 4 5summon 1 2 1attack 1 2endattack 1 1
