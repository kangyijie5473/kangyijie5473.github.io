...
description: 介绍SSH免密登录的配置方法（生成公私钥、配置authorized_keys），并简要解释非对称加密原理。附带一个关于校园网自动登录的脚本分享。
---
介绍SSH免密登录的配置方法（生成公私钥、配置authorized_keys），并简要解释非对称加密原理。附带一个关于校园网自动登录的脚本分享。
