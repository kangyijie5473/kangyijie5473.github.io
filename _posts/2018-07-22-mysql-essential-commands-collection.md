...
date: 2018-07-22
tags: [Database]
description: "本文汇集了作者长期使用的MySQL常用命令，方便快速查阅。涵盖了查看表结构、数据更新、重命名表/数据库（特别是针对InnoDB的技巧）、设置远程访问权限、以及查看数据库表数量、连接数、配置变量和存储容量等实用操作。"
---
本文汇集了作者长期使用的MySQL常用命令，方便快速查阅。涵盖了查看表结构、数据更新、重命名表/数据库（特别是针对InnoDB的技巧）、设置远程访问权限、以及查看数据库表数量、连接数、配置变量和存储容量等实用操作。
