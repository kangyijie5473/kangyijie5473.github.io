...
date: 2017-11-09
tags: [Network, C/C++, AI, Linux]
description: 网络编程定时事件处理系列第三篇。介绍时间轮（Time Wheel）算法原理，并分析腾讯Libco协程库中如何使用时间轮高效管理定时事件，优化O(N)的链表查找。
---
网络编程定时事件处理系列第三篇。介绍时间轮（Time Wheel）算法原理，并分析腾讯Libco协程库中如何使用时间轮高效管理定时事件，优化O(N)的链表查找。
