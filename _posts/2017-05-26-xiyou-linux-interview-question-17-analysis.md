...
date: 2017-05-26
tags: [Career, Linux, Network, AI, Life]
description: 解析西邮Linux兴趣小组纳新面试题第17题，涉及C语言结构体内存对齐、大小端模式（Little-Endian/Big-Endian）以及强制类型转换对指针解引用的影响。
---
解析西邮Linux兴趣小组纳新面试题第17题，涉及C语言结构体内存对齐、大小端模式（Little-Endian/Big-Endian）以及强制类型转换对指针解引用的影响。
