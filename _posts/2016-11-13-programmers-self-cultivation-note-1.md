...
date: 2016-11-13
tags: [C/C++, Linux]
description: "本文是《程序员的自我修养》读书笔记的第一部分，主要涵盖了第二章和第三章的内容。文章详细介绍了C语言程序从源代码到可执行文件的四个阶段（预处理、编译、汇编、链接），解释了链接的作用与必要性，并初步探讨了目标文件（ELF格式）的结构，包括代码段、数据段的划分以及文件头信息的查看方法。"
---
本文是《程序员的自我修养》读书笔记的第一部分，主要涵盖了第二章和第三章的内容。文章详细介绍了C语言程序从源代码到可执行文件的四个阶段（预处理、编译、汇编、链接），解释了链接的作用与必要性，并初步探讨了目标文件（ELF格式）的结构，包括代码段、数据段的划分以及文件头信息的查看方法。
