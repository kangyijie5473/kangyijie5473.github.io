...
date: 2017-04-30
tags: [Redis, Python]
description: 记录了Redis Cluster集群的搭建过程，包括Redis配置、Ruby环境安装及集群创建。同时提供了一个使用Python操作Redis集群的简单示例代码。
---
记录了Redis Cluster集群的搭建过程，包括Redis配置、Ruby环境安装及集群创建。同时提供了一个使用Python操作Redis集群的简单示例代码。
