...
date: 2017-10-16
tags: [Tools]
description: 介绍持续集成（Continuous Integration）的概念及其在开源项目中的应用。以Travis CI为例，讲解了如何为GitHub上的开源项目配置自动化构建和测试流程（.travis.yml）。
---
介绍持续集成（Continuous Integration）的概念及其在开源项目中的应用。以Travis CI为例，讲解了如何为GitHub上的开源项目配置自动化构建和测试流程（.travis.yml）。
