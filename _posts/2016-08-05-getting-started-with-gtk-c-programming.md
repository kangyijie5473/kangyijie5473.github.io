...
date: 2016-08-05
tags: [C/C++]
description: "本文介绍了使用C语言进行GTK图形界面开发的基础知识。作者分享了学习GTK的初体验，解释了GTK程序的基本步骤（声明变量、设置控件、事件设置），并重点讲解了事件驱动编程的思想以及 `g_signal_connect` 函数的使用。最后给出了开发建议，如使用自动补全、Makefile和双屏开发。"
---
本文介绍了使用C语言进行GTK图形界面开发的基础知识。作者分享了学习GTK的初体验，解释了GTK程序的基本步骤（声明变量、设置控件、事件设置），并重点讲解了事件驱动编程的思想以及 `g_signal_connect` 函数的使用。最后给出了开发建议，如使用自动补全、Makefile和双屏开发。
