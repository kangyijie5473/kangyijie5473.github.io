...
date: 2017-05-24
tags: [Python, Linux]
description: 介绍守护进程（Daemon）的概念及其特点。通过一个Python实现的后台监控程序Demo，详细讲解了编写守护进程的步骤，包括两次fork、脱离终端、重设文件权限掩码等。
---
介绍守护进程（Daemon）的概念及其特点。通过一个Python实现的后台监控程序Demo，详细讲解了编写守护进程的步骤，包括两次fork、脱离终端、重设文件权限掩码等。
