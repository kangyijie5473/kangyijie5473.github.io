...
date: 2019-04-02
tags: [Database, Linux, Career, Network, C/C++, Life]
description: "本文是作者从C++后台开发转战Java Web开发（SSM框架）的学习总结。作者分享了从零接触Spring、SpringMVC、MyBatis的体验，赞赏了Java Web开发的效率与清晰的架构（Entity、DAO、Service、Controller），并以一个简单的用户管理项目为例，详细解析了前后端分离架构下的后端开发流程。"
---
本文是作者从C++后台开发转战Java Web开发（SSM框架）的学习总结。作者分享了从零接触Spring、SpringMVC、MyBatis的体验，赞赏了Java Web开发的效率与清晰的架构（Entity、DAO、Service、Controller），并以一个简单的用户管理项目为例，详细解析了前后端分离架构下的后端开发流程。
