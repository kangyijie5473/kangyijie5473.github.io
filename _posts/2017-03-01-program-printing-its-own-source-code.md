...
date: 2017-03-01
tags: [Python, AI, C/C++]
description: 介绍一个有趣的编程挑战：不打开源文件，打印程序自身的第N行代码。探讨了将源代码作为字符串存储在可执行文件中的思路，并给出了一个Python实现示例。
---
介绍一个有趣的编程挑战：不打开源文件，打印程序自身的第N行代码。探讨了将源代码作为字符串存储在可执行文件中的思路，并给出了一个Python实现示例。
