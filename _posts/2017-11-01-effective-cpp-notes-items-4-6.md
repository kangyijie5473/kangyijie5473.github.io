...
date: 2017-11-01
tags: [Python, C/C++]
description: 《Effective C++》读书笔记第二部分，涵盖条款4-6。重点讲解了确保对象在使用前被初始化（初始化列表 vs 赋值），以及C++中初始化顺序的规则。
---
《Effective C++》读书笔记第二部分，涵盖条款4-6。重点讲解了确保对象在使用前被初始化（初始化列表 vs 赋值），以及C++中初始化顺序的规则。
