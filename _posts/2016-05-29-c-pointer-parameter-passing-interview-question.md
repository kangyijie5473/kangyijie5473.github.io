...
date: 2016-05-29
tags: [Life, Career, C/C++]
description: "本文通过一道面试题探讨了C语言中的函数参数传递机制。重点解释了二级指针在改变指针指向时的作用，辨析了值传递与地址传递的区别，并阐述了数组名作为指针常量的特性以及数组作为参数退化为指针的原因。"
---
本文通过一道面试题探讨了C语言中的函数参数传递机制。重点解释了二级指针在改变指针指向时的作用，辨析了值传递与地址传递的区别，并阐述了数组名作为指针常量的特性以及数组作为参数退化为指针的原因。
