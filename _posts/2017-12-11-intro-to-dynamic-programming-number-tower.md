...
date: 2017-12-11
tags: [Algorithm, Network, Life]
description: 动态规划（DP）入门教程。通过经典的“数塔”问题（HDU 2084）和“矩形嵌套”问题，讲解了DP的基本思想、状态转移方程的推导以及如何从递归转向递推。
---
动态规划（DP）入门教程。通过经典的“数塔”问题（HDU 2084）和“矩形嵌套”问题，讲解了DP的基本思想、状态转移方程的推导以及如何从递归转向递推。
