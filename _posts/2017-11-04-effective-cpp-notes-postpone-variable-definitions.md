...
date: 2017-11-04
tags: [Tools, Python, C/C++]
description: 《Effective C++》读书笔记第三部分，重点讨论条款26：尽量延后变量的定义。分析了循环内定义变量与循环外定义变量的效率差异及作用域选择。
---
《Effective C++》读书笔记第三部分，重点讨论条款26：尽量延后变量的定义。分析了循环内定义变量与循环外定义变量的效率差异及作用域选择。
